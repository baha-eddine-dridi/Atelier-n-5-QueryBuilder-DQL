 ...
 */
                ...
                /**
     * @Route("/list-authors-by-email", name="list_authors_by_email")
     */
    ...
    //Ajouter une zone de recherche dans la liste des auteurs permettant de rechercher la liste des auteurs dont le nombre de livres est compris entre deux valeurs
   /**
    ...
    public function searchAuthorsByBookCount(AuthorRepository $authorRepository, Request $request): Response
    {
        ...
        return $this->render('author/search_authors_by_book_count.html.twig', [
    ...
    /**
     * @Route("/delete-authors-with-zero-books", name="delete_authors_with_zero_books")
     */
    public function deleteAuthorsWithZeroBooks(AuthorRepository $authorRepository): Response
    {
        ...
        return $this->redirectToRoute('app_Affiche'); // Rediriger vers la liste des auteurs ou une autre page
    }
